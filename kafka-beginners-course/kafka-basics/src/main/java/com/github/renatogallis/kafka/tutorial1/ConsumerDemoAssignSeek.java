...
public class ConsumerDemoAssignSeek {
	...
	public static void main(String[] args) {
		...
		//assign:
		TopicPartition partitionToReadFrom = new TopicPartition(topic,partition);//Passando qual partition precisa enxergar dentro do tópico
		long offsetToReadFrom = 15L;
		consumer.assign(Arrays.asList(partitionToReadFrom));//Arrays.aslist para transformar em uma collection
		
		//seek:
		consumer.seek(partitionToReadFrom,offsetToReadFrom);
		//Aqui informo a partição que quero ler e o offset onde quero estar
